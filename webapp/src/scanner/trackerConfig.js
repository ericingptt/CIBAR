...
export const TRACKER_TARGETS = [
  ...
  { index: 2, name: 'target2 / girl', scenario: 'romance', label: '假交友', route: '/scenario02-romance' },
  { index: 3, name: 'target3 / girl1', scenario: 'romance', label: '假交友', route: '/scenario02-romance' },
  { index: 4, name: 'target4 / girl2', scenario: 'romance', label: '假交友', route: '/scenario02-romance' },
  { index: 5, name: 'target5 / girl3', scenario: 'romance', label: '假交友', route: '/scenario02-romance' },
