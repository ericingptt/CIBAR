// Small hand-drawn icon set in Lucide's visual language (24x24, round-cap
// strokes, currentColor) - avoids adding an icon-library dependency to the
// project for three glyphs.
