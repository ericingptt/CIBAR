...
// upstream (the scenario menu calls resetScenario02() before navigating
// here); this page's only job is to show the intro and hand off to
// dating-browse.
  ...
  return (
    <div className="romance-brief-page">
      <div className="romance-brief-topline">
        ...
        <Link className="romance-brief-back" to="/scenario-menu">返回情境選單</Link>
      </div>
