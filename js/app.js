...
if('ResizeObserver' in window){const stage=document.querySelector('.ar-stage');if(stage){let raf=null;new ResizeObserver(()=>{if(raf)cancelAnimationFrame(raf);raf=requestAnimationFrame(fitStage)}).observe(stage)}}
